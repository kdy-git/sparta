...
<section class="hero is-white">
            ...
            <div class="field">
                <p class="control">
                    <button id="input-post"
                            onclick='$("#modal-post").addClass("is-active")'>로그인
                </p>
            </div>
        </div>
    </article>
    ...
    <article class="media">
        <div class="media-content">
            <div class="field">
                <p class="control">
                    <button id="input-post1"
                            onclick='$("#modal-post1").addClass("is-active")'>회원가입
                </p>
            </div>
        </div>
    </article>
                        ...
                        <article class="media">
                            <div class="media-content">
                                <div class="content">
                                    ...
                                    <p id="help-id" class="help">아이디는 2-10자의 영문과 숫자와 일부 특수문자(._-)만 입력
                                        가능합니다.</p>
                                ...
                                <div id="sign-up-box">
                                    <div class="mb-5">
                                        <div class="field">
                                            ...
                                            <p id="help-password2" class="help">비밀번호를 다시 한 번
                                                입력해주세요.</p>
